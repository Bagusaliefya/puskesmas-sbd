    ...
    <div class="flex items-center gap-4 mb-8">
        ...
        <div>
            <h1 class="text-2xl font-bold flex items-center gap-2" style="color:oklch(12% 0.028 262)">
                <span class="material-symbols-outlined" style="color:oklch(52% 0.1 182)">edit</span>
                Edit Pasien</h1>
            <p class="text-sm" style="color:oklch(20% 0.024 262 / .6)">Ubah data pasien</p>
        </div>
    </div>
            ...
            <form method="POST" action="{{ route('pasien.update', $pasien) }}">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="form-control md:col-span-2">
                        ...
                        <input type="text" name="nama_pasien" class="input input-bordered w-full @error('nama_pasien') input-error @enderror" value="{{ old('nama_pasien', $pasien->nama_pasien) }}" placeholder="Masukkan nama lengkap" required pattern="[A-Za-z\s\.\']+" title="Hanya huruf yang diperbolehkan" oninput="this.value = this.value.replace(/[^A-Za-z\s\.\']/g, '')">
                    ...
                    <div class="form-control">
                        ...
                        <input type="date" name="tanggal_lahir" class="input input-bordered w-full @error('tanggal_lahir') input-error @enderror" value="{{ old('tanggal_lahir', $pasien->tanggal_lahir) }}">
                    ...
                    <div class="form-control">
                        ...
                        <input type="tel" name="no_hp" inputmode="numeric" pattern="[0-9]+" oninput="this.value = this.value.replace(/[^0-9]/g, '')" class="input input-bordered w-full @error('no_hp') input-error @enderror" value="{{ old('no_hp', $pasien->no_hp) }}" placeholder="08xxxxxxxxxx" title="Hanya angka">
                    ...
                    <div class="form-control">
                        ...
                        <select name="golongan_darah" class="select select-bordered w-full @error('golongan_darah') select-error @enderror">
                            ...
                            <option value="A" @selected(old('golongan_darah', $pasien->golongan_darah) === 'A')>A</option>
                            <option value="B" @selected(old('golongan_darah', $pasien->golongan_darah) === 'B')>B</option>
                            <option value="AB" @selected(old('golongan_darah', $pasien->golongan_darah) === 'AB')>AB</option>
                            <option value="O" @selected(old('golongan_darah', $pasien->golongan_darah) === 'O')>O</option>
                        </select>
                    ...
                    <div class="form-control md:col-span-2">
                        ...
                        <textarea name="alamat" class="textarea textarea-bordered w-full @error('alamat') textarea-error @enderror" rows="3" placeholder="Masukkan alamat lengkap">{{ old('alamat', $pasien->alamat) }}</textarea>
