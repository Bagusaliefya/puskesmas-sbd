    ...
    <div class="flex items-center gap-4 mb-8">
        ...
        <div>
            <h1 class="text-2xl font-bold flex items-center gap-2">
                ...
                Tambah Obat</h1>
            <p class="text-sm" style="color:oklch(20% 0.024 262 / .6)">Masukkan data obat baru</p>
        </div>
    </div>
            ...
            <form method="POST" action="{{ route('obat.store') }}">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="form-control md:col-span-2">
                        ...
                        <input type="text" name="nama_obat" class="input input-bordered w-full @error('nama_obat') input-error @enderror" value="{{ old('nama_obat') }}" placeholder="Masukkan nama obat" required>
                    ...
                    <div class="form-control">
                        ...
                        <input type="number" name="stok" class="input input-bordered w-full @error('stok') input-error @enderror" value="{{ old('stok', 0) }}" min="0" required>
                    ...
                    <div class="form-control">
                        ...
                        <input type="number" name="stok_minimum" class="input input-bordered w-full @error('stok_minimum') input-error @enderror" value="{{ old('stok_minimum', 10) }}" min="0" required>
                    ...
                    <div class="form-control">
                        ...
                        <input type="number" name="harga" class="input input-bordered w-full @error('harga') input-error @enderror" value="{{ old('harga', 0) }}" min="0" required>
